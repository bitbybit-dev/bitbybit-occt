...
export declare class ShapeFix_Edge extends Standard_Transient {
  ...
  FixAddPCurve_3(edge: TopoDS_Edge, face: TopoDS_Face, isSeam: Standard_Boolean, surfana: Handle_ShapeAnalysis_Surface, prec: Standard_Real): Standard_Boolean;
  FixAddPCurve_4(edge: TopoDS_Edge, surface: Handle_Geom_Surface, location: TopLoc_Location, isSeam: Standard_Boolean, surfana: Handle_ShapeAnalysis_Surface, prec: Standard_Real): Standard_Boolean;
  FixAddCurve3d(edge: TopoDS_Edge): Standard_Boolean;
  FixVertexTolerance_1(edge: TopoDS_Edge, face: TopoDS_Face): Standard_Boolean;
  FixVertexTolerance_2(edge: TopoDS_Edge): Standard_Boolean;
  FixReversed2d_1(edge: TopoDS_Edge, face: TopoDS_Face): Standard_Boolean;
  FixReversed2d_2(edge: TopoDS_Edge, surface: Handle_Geom_Surface, location: TopLoc_Location): Standard_Boolean;
  FixSameParameter_1(edge: TopoDS_Edge, tolerance: Standard_Real): Standard_Boolean;
  FixSameParameter_2(edge: TopoDS_Edge, face: TopoDS_Face, tolerance: Standard_Real): Standard_Boolean;
  Status(status: ShapeExtend_Status): Standard_Boolean;
  SetContext(context: Handle_ShapeBuild_ReShape): void;
  Context(): Handle_ShapeBuild_ReShape;
  static get_type_name(): Standard_Character;
...
export type OpenCascadeInstance = {FS: typeof FS} & {
  ...
  ShapeExtend_Status: ShapeExtend_Status;
